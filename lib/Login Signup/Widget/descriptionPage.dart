...
class ImagePage extends StatefulWidget {
  final String svgImagePath; // Change to accept SVG image path
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Text(
                      'You have completed this module and earned 25 points!',
              ...
              BuildTopButton(
                onTap: () {
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) =>
                          ModulePage(), // Replace with your module page
                    ),
                  );
                },
                text: 'Back to Module',
          ...
          children: [
            Padding(
              ...
              child: Container(
                ...
                child: Image.asset(
                "assets/images/${widget.svgImagePath}", // Replace with your logo path
