...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> loginUser() async {
    ...
    if (!isConnected) {
      showSnackBar(context, "No internet connection. Please check your network settings.", Colors.red);
      return;
    }
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: SingleChildScrollView(
          child: Padding(
            padding: EdgeInsets.symmetric(horizontal: width * 0.04), // Adjust padding
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.center,
              children: [
                SizedBox(
                  height: height * 0.39,
                  child: Image.asset('assets/images/Medical research-amico.png'),
                ),
                ...
                SizedBox(
                  ...
                  child: TextFieldInput(
                    ...
                    textInputType: TextInputType.emailAddress, // Use emailAddress type
                  ),
                ),
                SizedBox(height: height * 0.02),
                // Password input
