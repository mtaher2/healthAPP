...
class _ScenarioPageState extends State<ScenarioPage> {
  ...
  bool _hasInternetConnection = true; // To track internet connection status
  ...
  Future<void> _checkInternetConnection() async {
    ...
    if (connectivityResult == ConnectivityResult.none) {
      ...
      _checkExistingSubmission(); // Check the database only if there's internet
    }
  }
  ...
  Future<void> _checkExistingSubmission() async {
    ...
    setState(() {
      _isLoading = false; // Stop loading when the database check is complete
    });
  }
              ...
              TextField(
                ...
                decoration: const InputDecoration(
                  ...
                  border: OutlineInputBorder(
                    borderSide: BorderSide(color: Color(0xFF3058a6)),
                  ),
